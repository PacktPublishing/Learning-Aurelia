# Contacts Management Application - Translated

This is a sample of the Contacts Management Application used in chapter 8, with only the hard-coded texts being translated.
