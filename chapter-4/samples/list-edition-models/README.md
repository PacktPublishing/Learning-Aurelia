# Contacts Management Application - List Edition using Dialogs

This is a sample of the Contacts Management Application used in chapter 4, to illustrate how list edition can be done with dialogs using the ```aurelia-dialog``` plugin.
