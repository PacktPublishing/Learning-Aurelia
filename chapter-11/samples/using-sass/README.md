# Contacts Management Application - Using SASS

This is a sample of the Contacts Management Application used in chapter 11, showing how to use SASS instead of plain CSS.
